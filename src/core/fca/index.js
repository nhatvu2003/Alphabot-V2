...
// Friendly, localized error message to show when userID cannot be retrieved.
const ERROR_RETRIEVING = "Không thể lấy userID. Vui lòng kiểm tra appstate (cookies) hoặc đăng nhập lại bằng trình duyệt để xác minh tài khoản. Nếu Facebook chặn đăng nhập từ vị trí mới, kiểm tra email/notifications hoặc thử kết nối mạng khác (VPN).";
